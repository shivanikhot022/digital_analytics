...
with tab2:
    ...
    plt.title("Repeat Sessions by Days Bin")
    plt.xlabel("Days Bin")
    ...
    with col2:
        ...
        st.pyplot(plt)
with tab3:
    st.header("1️⃣Marketing Traffic & Channel Performanc")
    st.subheader("🎯 Purpose of This Dashboard")
    st.write("""
    This dashboard provides a detailed view of marketing channel performance.
    It helps marketing managers analyze traffic sources, conversion rates,
    and visitor behavior to optimize acquisition strategies.""")

    # slicers
    with st.expander("🎛️ Slicers (Filters Available)"):
        st.write("""
        • Year filter allows analysis across multiple years.  
        • Campaign filter helps evaluate specific marketing campaigns.  
        • Month filter highlights seasonal traffic and conversion trends.  
        • Day Type filter compares weekday vs weekend performance.  
        • Channel & Channel Type filters allow deep-dive into acquisition sources.""")

    # KPI Cards
    with st.expander("📌 KPI Cards Explanation"):
        st.write("""
        • Total Visitors (394K) shows overall website reach.  
        • New Visitors % (87.00%) indicates strong acquisition of fresh audiences.  
        • Conversion Rate % (6.83%) reflects efficiency of traffic converting to sales.  
        • Top Channel by Session (gsearch) highlights the leading traffic driver.  
        • gsearch Conversion Rate (6.75%) shows its effectiveness.  
        • Average Session YoY % (82.17%) indicates strong growth in engagement.  
        • Free Channel Revenue (355.7) vs Paid Channel Revenue (1.50M) shows ROI balance.""")

    # Charts
    with st.expander("📊 Charts and Business Insights"):

        st.markdown("### Total Sessions by Month & Channel Type")
        st.markdown("""
        ...
        **Insight:** Paid Search is the primary traffic driver and highly seasonal.
        ...
        st.markdown("### Traffic Campaign Segment Trending")
        st.markdown("""
        ...
        **Insight:** Search intent traffic converts better than social traffic.
        ...
        st.markdown("### Paid vs Free — Conversion Rate %")
        st.markdown("""
        ...
        **Insight:** Optimizing paid targeting can significantly improve ROI.
        ...
        st.markdown("### New vs Repeat Session Rate by Channel Type")
        st.markdown("""
        ...
        **Insight:** Direct traffic indicates stronger brand recall and customer loyalty.
        ...
        st.markdown("### Paid vs Free — Sessions & Orders")
        st.markdown("""
        ...
        **Insight:** Budget reallocation toward high-converting channels can improve overall performance.
        ...
        st.markdown("### Repeat Visitors by Channel Type")
        st.markdown("""
        ...
        **Insight:** Retention strategies are strongest in Direct channel and weakest in Social.
        ...
        st.markdown("### Marketing Manager Final Summary")
        st.markdown("""
        - Paid Search is the largest traffic driver but not the most efficient converter.  
        - Free traffic has higher conversion efficiency but lower volume.  
        - Direct channel performs best in retention and repeat visits.  
        - Social campaigns underperform in both conversion and retention.  
        - Optimizing paid targeting and landing pages can significantly improve ROI.  
        """)
        
    #Customer Retention & Behavior Analysis
    st.header("1️2️⃣Customer Retention & Behavior Analysis")
    st.subheader("🎯 Purpose of This Dashboard")
    st.write("""
    This dashboard focuses on customer retention, repeat behavior, and loyalty trends.
    It helps managers understand engagement patterns and optimize retention strategies.""")

    # slicers
    with st.expander("🎛️ Slicers (Filters Available)"):
        st.write("""
        • Year filter allows tracking retention across years.  
        • Campaign filter highlights repeat performance by campaign.  
        • Month filter shows seasonal repeat trends.  
        • Day Type filter compares weekday vs weekend repeat sessions.  
        • Channel & Channel Type filters allow retention analysis by acquisition source.""")

    # KPI Cards
    with st.expander("📌 KPI Cards Explanation"):
        st.write("""
        • Average Days Since First Session (7.25) shows engagement cycle length.  
        • Total Visitors (394K) indicates overall reach.  
        • Repeat Visitors (13.00%) highlights loyalty challenge.  
        • Repeat Session Rate % (16.61%) shows engagement depth.  
        • Average Repeat Visitor YoY (129.53%) indicates strong growth in retention.  
        • Top Campaign by Repeat Visitors (brand) shows brand campaigns driving loyalty.  
        • Repeat Visitors (51K) quantifies loyal customer base.""")

    # Charts
    with st.expander("📊 Charts and Business Insights"):
        st.markdown("### Repeat Sessions by Days Bin")
        st.markdown("""
        ...
        **Insight:** Most customers return after a long gap, indicating weak short-term retention strategy.
        ...
        st.markdown("### Repeat Sessions Trend by Month")
        st.markdown("""
        ...
        **Insight:** Retention performance improves toward year-end but drops significantly in Q2.
        ...
        st.markdown("### Repeat Visitors by Device")
        st.markdown("""
        ...
        **Insight:** Mobile experience optimization can improve repeat engagement.
        ...
        st.markdown("### Repeat Revenue by Channel")
        st.markdown("""
        ...
        **Insight:** Search campaigns are highly valuable for long-term customer value.
        ...
        st.markdown("### Repeat Session Rate by Product")
        st.markdown("""
        ...
        **Insight:** The Original Mr. Fuzzy is the strongest product for customer loyalty.
        ...
        st.markdown("### Repeat Customers by Channel")
        st.markdown("""
        ...
        **Insight:** Paid Search is effective not only for acquisition but also for retention.
        ...
        st.markdown("### Marketing Retention Summary")
        st.markdown("""
        - Repeat behavior is strongest in search-driven channels.  
        - Most customers return after 30+ days, indicating delayed engagement cycles.  
        - Desktop users show stronger loyalty than mobile users.  
        - One flagship product dominates repeat purchases.  
        - Social campaigns underperform in long-term customer retention.
        """)
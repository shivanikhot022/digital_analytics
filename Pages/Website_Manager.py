...
with tab3:
    ...
    # Executive Overview
    st.header("1️⃣  Website Traffic- Engagement Performance")
    st.subheader("🎯 Purpose of This Dashboard")
    st.write("""
    This dashboard provides marketing managers with a strategic overview of campaign effectiveness,
    traffic acquisition, and engagement performance. It helps identify high-performing channels,
    optimize conversion rates, and improve ROI across marketing initiatives.""")

    # slicers
    with st.expander("🎛️ Slicers (Filters Available)"):
        st.write("""
        • The Year slicer allows analysis of campaign performance across multiple years.  
        • The Month filter helps identify seasonal trends and monthly conversion patterns.  
        • The Device Type slicer compares desktop vs mobile engagement and bounce behavior.  
        • The UTM Campaign filter enables evaluation of individual campaign effectiveness.  
        • The Session Type slicer helps distinguish between paid, organic, and direct traffic.""")

    # KPI Cards
    with st.expander("📌 KPI Cards Explanation"):
        st.write("""
        • Total Sessions (473K) shows the overall traffic driven by marketing efforts.  
        • New Sessions (394K) indicates strong acquisition performance.  
        • Revenue per Session (3.92) reflects marketing efficiency in generating sales.  
        • Repeat Session Rate (16.61%) shows returning visitor engagement.  
        • Total Visitors (394K) highlights reach across unique users.  
        • Repeat Visitors (51K) shows loyalty and retention impact.  
        • Sessions Last Year (409K) provides YoY comparison for growth tracking.""")

    # Charts
    with st.expander("📊 Charts and Marketing Insights"):
        st.markdown("### Sessions and Conversion Rate by Month")
        st.markdown("""
        ...
        **Insight:** Improving mobile experience could significantly increase total conversions.
        ...
        st.markdown("### Revenue per Session Type by Product")
        st.markdown("""
        ...
        **Insight:** Acquisition traffic drives revenue, but increasing repeat session monetization is an opportunity.
        ...
        st.markdown("### Conversion Rate by Days")
        st.markdown("""
        ...
        **Insight:** Weekend conversion improvement strategies could increase overall weekly performance.
        ...
        st.markdown("### Conversion Rate by Time Buckets")
        st.markdown("""
        ...
        **Insight:** Traffic quality is stable throughout the day, suggesting strong audience targeting.
        ...
        st.markdown("### Users by Device Type")
        st.markdown("""
        ...
        **Insight:** Mobile growth opportunity is large if conversion rate improves.
        ...
        st.markdown("### Users by Pageview URL")
        st.markdown("""
    ...
    st.header("2️⃣ Website Conversion Funnel Analysis")
    st.subheader("🎯 Purpose of This Dashboard")
    st.write("""This section focuses on refining campaign targeting, improving bounce rates,
    and maximizing conversion efficiency across channels and devices.""")

    # KPI Cards
    with st.expander("📌 KPI Cards Explanation"):
        st.write(""" • Bounced Sessions (211.64K) shows sessions with only one pageview.  
        • Bounce Rate (44.76%) indicates the percentage of disengaged visitors.  
        • Converted Sessions (32K) reflects successful campaign-driven conversions.  
        • Conversion Rate (6.83%) shows overall campaign effectiveness.  
        • Avg Pages per Session (2.51) highlights user engagement depth.  
        • Average Session YoY Growth (82.17%) shows strong year-over-year traffic growth.""")

    # Charts
    with st.expander("📊 Charts and Engagement Insights"):
        ...
        **Insight:** High traffic pages are not always the highest converting, suggesting optimization opportunity.
        ...
        st.markdown("### Bounce Rate by Landing Page")
        st.markdown("""
        ...
        **Insight:** Pages with high bounce and low conversion require content or UX improvement.
        ...
        st.markdown("### Session by Page Type (Funnel Analysis)")
        st.markdown("""
        ...
        **Insight:** There is a significant drop-off from product page to cart stage, indicating funnel leakage.
        ...
        st.markdown("### Overall Website Performance Summary")
        st.markdown("""
        - Traffic is strong but heavily dependent on a few landing pages.
        - Conversion rate is stable but has clear mobile performance gaps.
        - Bounce rate is higher on certain landing pages, affecting conversions.
        - Funnel drop-offs are most significant between product and cart stages.
        - Mobile optimization and landing page improvements can drive immediate gains.
        """)